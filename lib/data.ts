...
export const games: Game[] = [
  {
    slug: "maths-play",
    title: "Maths Play — Mixed Practice",
    ...
    category: "Math Games",
    tags: ["math", "maths play", "addition", "subtraction", "multiplication"],
  ...
  },
  {
    ...
    description: "Use the number key to fill in the picture with the correct colours. A fun digital coloring activity!",
    category: "Coloring Games",
    tags: ["coloring", "numbers", "art", "creative"],
    component: "CountingGame",
    difficulty: "easy",
    ageRange: "4–8",
  },
  ...
  },
  {
    slug: "shape-sorter",
    title: "Shape Sorter",
    description: "Identify shapes as fast as you can! Learn circles, squares, triangles and more.",
    category: "Educational Games",
    tags: ["shapes", "sorting", "educational", "toddler"],
    component: "AlphabetMatchGame",
    difficulty: "easy",
    ageRange: "2–5",
  },
  {
    slug: "spelling-bee",
    title: "Spelling Bee",
    description: "Fun spelling questions for early readers. Build vocabulary and spelling skills!",
    category: "Educational Games",
    tags: ["spelling", "words", "reading", "educational"],
    component: "AlphabetMatchGame",
    difficulty: "medium",
    ageRange: "5–8",
  },
