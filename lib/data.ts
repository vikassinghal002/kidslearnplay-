...
export const games: Game[] = [
  {
    slug: "fractions-frenzy",
    title: "Fractions Frenzy",
    description: "Learn fractions the fun way! Look at the pizza pie, count the shaded slices and pick the matching fraction. A visual fractions game for kids that makes 1/2, 3/8 and 5/6 feel easy.",
    category: "Math Games",
    tags: ["fractions", "fractions games for kids", "math", "pie chart", "visual math"],
    component: "FractionsFrenzyGame",
    difficulty: "medium",
    ageRange: "7–11",
  },
  {
    slug: "money-match",
    title: "Money Match",
    description: "A counting money game for kids — tap pennies, nickels, dimes and quarters to make the target amount. Perfect for learning US coins and simple addition.",
    category: "Math Games",
    tags: ["counting money", "money games", "coins", "addition", "math"],
    component: "MoneyMatchGame",
    difficulty: "easy",
    ageRange: "5–9",
  },
  {
    slug: "spelling-bee",
    title: "Spelling Bee",
    description: "A fun spelling game for kids with a bee mascot! Look at the picture and arrange letter tiles to spell the word before the 30-second timer runs out. Builds sight word mastery.",
    category: "Educational Games",
    tags: ["spelling games for kids", "spelling bee", "sight words", "reading", "letters"],
  ...
  },
  {
    slug: "time-teller",
    title: "Time Teller",
    description: "A telling time game for kids — read the analog clock and pick the right time. Starts with hours, then half-hours, then quarter-hours. Great practice for learning to read a clock.",
    category: "Math Games",
    tags: ["telling time games", "analog clock", "time", "math", "clock"],
    component: "TimeTellerGame",
    difficulty: "medium",
    ageRange: "6–10",
  },
  {
    slug: "addition-attack",
    title: "Addition Attack",
    description: "A fun addition game for kids! Asteroids drift down from space — tap the one showing the correct sum before it hits the ground. 15 rounds of math action with 3 lives and ramping difficulty.",
    category: "Math Games",
    tags: ["addition games for kids", "addition", "math", "asteroid", "arcade math"],
    component: "AdditionAttackGame",
    difficulty: "easy",
    ageRange: "5–8",
  },
  {
    slug: "subtraction-station",
    title: "Subtraction Station",
    description: "All aboard the subtraction train! Solve take-away problems to keep the train moving. A friendly subtraction game for kids with simple visuals and 12 rounds of practice.",
    category: "Math Games",
    tags: ["subtraction games", "subtraction", "math", "train", "take away"],
    component: "SubtractionStationGame",
    difficulty: "easy",
    ageRange: "5–9",
  },
  {
    slug: "division-duel",
    title: "Division Duel",
    description: "Face off against the CPU in a division battle! Answer problems before the timer fills — first to 5 wins. A race-the-clock division game for kids learning facts up to 12 × 10.",
    category: "Math Games",
    tags: ["division games for kids", "division", "math", "duel", "quick math"],
    component: "DivisionDuelGame",
    difficulty: "medium",
    ageRange: "7–11",
  },
  {
    ...
    description: "A phonics game for kids — pick the missing vowel in CVC words like c_t and d_g. Fill the rocket's fuel tank to launch! 3 levels of short-vowel practice for early readers.",
    category: "Educational Games",
    tags: ["phonics games for kids", "phonics", "cvc words", "vowels", "reading", "early reading"],
    component: "ReadingRocketGame",
    difficulty: "easy",
    ageRange: "4–7",
  },
  {
    slug: "sight-word-slam",
    title: "Sight Word Slam",
    description: "A fast-paced sight word game for kids! Tap the matching Dolch sight word before the timer runs out. Speed ramps up each round — perfect for building reading fluency.",
    category: "Educational Games",
    tags: ["sight word games", "sight words", "dolch", "reading", "fluency", "literacy"],
    component: "SightWordSlamGame",
    difficulty: "medium",
    ageRange: "5–8",
  },
  {
    slug: "sudoku-kids",
    title: "Sudoku Kids",
    description: "A kid-friendly 4×4 sudoku for kids — fill rows, columns and 2×2 boxes with the numbers 1 to 4. 5 rotating puzzles and a timer so you can beat your best time!",
    category: "Educational Games",
    tags: ["sudoku for kids", "sudoku", "logic", "puzzle", "brain game"],
    component: "SudokuKidsGame",
    difficulty: "medium",
    ageRange: "6–11",
  },
  {
